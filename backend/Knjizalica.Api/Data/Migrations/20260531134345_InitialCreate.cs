...
namespace Knjizalica.Api.Data.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    MemberCardNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MemberProfiles_Cities_CityId",
                        column: x => x.CityId,
                        principalTable: "Cities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MemberProfiles_MembershipStatuses_MembershipStatusId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BookId = table.Column<int>(type: "int", nullable: false),
                    InventoryCode = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Loans_MemberProfiles_MemberProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MemberProfiles_MemberCardNumber",
                table: "MemberProfiles",
                column: "MemberCardNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MemberProfiles_MembershipStatusId",
                table: "MemberProfiles",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_MemberProfileId_BookCopyId_FromDate_ToDate",
                table: "Reservations",
                columns: new[] { "MemberProfileId", "BookCopyId", "FromDate", "ToDate" });
